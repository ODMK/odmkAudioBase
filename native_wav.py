...
# Python .wav file read / write reference code
# From Native Python "wave" Library
# use: import wave !!!
# check native_wav_test.py for tb example
...
are compatible and have nothing to do with the actual position in the file.
